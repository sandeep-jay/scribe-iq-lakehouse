...
from orchestration.partitions import COHORT_PARTITIONS_NAME  # noqa: E402
from orchestration.resources import PlatformResource  # noqa: E402
...
def test_sensor_targets_bronze_and_silver_not_gold():
    ...
    from orchestration.sensors import SENSOR_TARGET_KEYS
