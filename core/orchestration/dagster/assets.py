...
def silver_tables(
    ...
    Mirrors :func:`core.surfaces.cli.pipeline.run_pipeline` for a single cohort: the same
    :func:`core.surfaces.cli.pipeline._parse_cohort` parses bundles (with optional DICOM
...
def gold_encounter_summary(
    ...
    keeping it co-located also matches what :func:`core.surfaces.cli.pipeline.build_gold` does.
    """
    p = platform.create()
