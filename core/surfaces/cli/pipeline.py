...
Run with ``python -m core.surfaces.cli.pipeline`` (defaults to LocalLitePlatform).
"""
...
from core.gold.encounter_summary import SILVER_SOURCES, TABLE_NAME, build_encounter_summary
...
def _parse_cohort(
    ...
    for path in files:
        try:
            ...
            # Redact the filename — it embeds the patient name/UUID (see core.redaction).
