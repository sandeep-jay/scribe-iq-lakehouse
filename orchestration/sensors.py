...
from local.ingest.bronze_landing import cohort_labels
from local.transforms.registry import SILVER_TABLES
from orchestration.partitions import COHORT_PARTITIONS_NAME, cohort_partitions
from orchestration.resources import PlatformResource

#: Assets the sensor materializes per cohort: Bronze + every Silver table.
#: Sourced from :data:`local.transforms.registry.SILVER_TABLES` so the selection
